...
Merges into production are deployed to http://composite-document-experiment.concord.org.

Other branches are deployed to http://composite-document-experiment.concord.org/branch/<name>.
...
11. Use https://github.com/concord-consortium/composite-document-experiment/releases to create a new release tag
...
Composite Document Experiment are Copyright 2018 (c) by the Concord Consortium and is distributed under the [MIT license](http://www.opensource.org/licenses/MIT).
